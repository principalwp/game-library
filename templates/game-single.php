...
<main id="gl-main" class="gl-container gl-game-single">

	<div class="gl-game-single__header">
	...
	<?php if ( empty( $visible_holders ) ) : ?>
		<p class="gl-empty-state"><?php esc_html_e( 'No public member libraries hold this game on this page.', 'game-library' ); ?></p>
	<?php else : ?>
